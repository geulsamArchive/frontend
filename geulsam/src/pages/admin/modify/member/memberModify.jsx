...
import { AdminWallpaper } from '../../../../style/admin/AdminMenu';
const MemberModify = () => {
    ...
    return (
      ...
      >
        관리자 정보
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <MemberTitle>
                            ...
                            <SearchWorkForMember
                                ...
                                placeholder="찾으시는 회원의 이름 혹은 학번을 적어주세요."
                            />
                        </MemberTitle>
                        {/* 회원 목록 테이블 */}
                        <ScrolledContainerTable>
                                                ...
                                                <TableRow key={member.userId}>
                                                    ...
                                                    <TableCell>
                                                        {member.level === 'SUSPENDED' ? (
                                                            <>
                                                                <BackButtonAtMyInfoModify
                                                                    onClick={() => rejectMember(member.schoolNum)}
                                                                >
                                                                    가입 거부
                                                                </BackButtonAtMyInfoModify>
                                                                <AllowButtonForPassword
                                                            ...
                                                            <>
                                                                ...
                                                                {isModalOpen && (
                                                                    <PasswordChangeEmail
                                                                        ...
                                                                        closeModal={closePasswordChangeEmailModal}
                                                                    />
                                                                )}
                                                            </>
                                                        )}
                    ...
                    <Desktop>
                        <WorkButtons>
                            <AdminButton onClick={() => navigate('/admin/manage')}>
                                일정&콘텐츠
                            </AdminButton>
                            <AdminButton disabled="true">회원관리</AdminButton>
