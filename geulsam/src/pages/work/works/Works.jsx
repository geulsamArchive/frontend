    ...
    <WorksContainer>
      <Mobile>
        <SearchWork
          ...
          placeholder="작품명이나 작가 이름을 입력하세요."
        />
      </Mobile>
      <Desktop>
        <SearchWork
          onSearch={handleSearch}
          placeholder="찾으시는 작품의 제목이나 작가명을 적어주세요."
        />
      </Desktop>
      <Mobile>
        <Centering>
          ...
          <GenreButton
            ...
            onClick={() => handleGenreClick('ESSAY')}
          >
            수필
          </GenreButton>
          <GenreButton
          ...
          <BookInfoContents>
            {workList.length === 0 ? (
              ...
              <>
                  ...
                  <div key={work.id}>
                    <WorkLink to={`/work/${work.contentId}`}>
                      ...
                      <Mobile>
                        <MobileWorkContainer>
                          <MobileWorkTop>
                            <MobileWorkTopLeft>{work.author}</MobileWorkTopLeft>
                            <MobileWorkTopRight>
                              {CheckTitleLength(work.title, 25)}
                            </MobileWorkTopRight>
                          </MobileWorkTop>
                          <MobileWorkBottom>{work.createdAt}</MobileWorkBottom>
                        </MobileWorkContainer>
                      </Mobile>
                    </WorkLink>
                  </div>
                ...
                <Desktop>
                  {workList.length < 12 &&
                    renderEmptyLogs(12 - workList.length)}
                </Desktop>
              </>
            )}
          </BookInfoContents>
